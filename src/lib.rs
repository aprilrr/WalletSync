...
#[derive(Debug)]
pub struct WalletSyncProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WalletSyncProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WalletSync processing");
    
    let mut processor = WalletSyncProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WalletSyncProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WalletSyncProcessor::new(false);
